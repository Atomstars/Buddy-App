            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        style={{ position: 'fixed', left: '50%', bottom: 0, zIndex: 301, width: 'min(100vw, 480px)', background: '#111113', borderRadius: '36px 36px 0 0', padding: '32px 24px', borderTop: '1px solid rgba(255,255,255,0.1)' }}
                    >
